...
const contractABI = require("../artifacts/contracts/Openzeppelincontracts.sol/Openzeppelincontracts.json").abi;

program
    .name("openzeppelincontracts-cli")
    .description("CLI tool for Openzeppelincontracts smart contract")
    .version("1.0.0");
