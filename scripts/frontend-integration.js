 ...
 * This file demonstrates how to integrate Openzeppelincontracts with a web frontend
 */

// For React/Vue/Angular applications
export class OpenzeppelincontractsClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OpenzeppelincontractsClient(provider, contractAddress);
